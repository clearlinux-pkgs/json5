...
Source0  : https://files.pythonhosted.org/packages/8d/97/b1b36d7a1b08d329a6743ced06a12c1b4085911953d6528e74366aec8f26/json5-0.9.1.tar.gz
...
%prep
%setup -q -n json5-0.9.1
cd %{_builddir}/json5-0.9.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581302182
...
cp %{_builddir}/json5-0.9.1/LICENSE %{buildroot}/usr/share/package-licenses/json5/c700a8b9312d24bdc57570f7d6a131cf63d89016
