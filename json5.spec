...
Source0  : https://files.pythonhosted.org/packages/91/06/fd24717500706cfe979f387daa220eb30b8632684de84083c1e4699ff440/json5-0.9.4.tar.gz
...
%prep
%setup -q -n json5-0.9.4
cd %{_builddir}/json5-0.9.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585315681
...
cp %{_builddir}/json5-0.9.4/LICENSE %{buildroot}/usr/share/package-licenses/json5/c700a8b9312d24bdc57570f7d6a131cf63d89016
